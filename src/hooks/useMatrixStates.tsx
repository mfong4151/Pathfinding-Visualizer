...
import { createNewMatrix } from '../components/Matricies/MatrixBanner/MatrixRemote/utils/graphUtils';
...
const DEFAULT_MATRIX_Y:number = 25;
const DEFAULT_MATRIX_X:number = 25;
